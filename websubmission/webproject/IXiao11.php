...
<head>
    ...
    <link rel="stylesheet" href="IXiao11.css">
    ...
    <title>VSVN Mobile | Phones</title>
</head>
        ...
        <div class="hero">
            <div class="row">
                <div class="col">
                    <div class="slider">
                        <div class="product">
                            <img src="image/pro4a.png" alt="" onclick="clickme(this)">
                            <img src="image/pro4b.png" alt="" onclick="clickme(this)" >
                            <img src="image/pro4c.png" alt="" onclick="clickme(this)" >
                            <img src="image/pro4main.png" alt="" onclick="clickme(this)">
                        </div>
                        <div class="preview">
                            <img src="image/pro4a.png" id="imagebox">
                        </div>
                    </div>
                </div>
                <div class="col">
                ...
                <fieldset>
                <div class="content">
                    <h1 style="font-family: 'Bungee Outline', cursive; text-align: center;font-size: 35px;"><mark>IXiao 11</mark></h1>
                    <h2 style=" text-align: center; font-size: 20px;"><small><sup>RM</sup></small>1760.00</h2>
                </div>
                ...
                <select name="Color" id="choice">
                    ...
                    <option value="choice2">Red</option>
                ...
                <label for="choice"><b style="line-height: 20px;">Contract Plan : </b></label>
                    <select name="Rateplan" id="choice">
                        ...
                        <option value="choice1">12 Months Postpaid Plan - Omg ABC6</option>
                    </select>
                 </div>
