...
<head>
    ...
    <link rel="stylesheet" href="IKwong3lite.css">
        ...
        <div class="hero">
            <div class="row">
                <div class="col">
                    <div class="slider">
                        <div class="product">
                            <img src="image/pro7main.png" alt="" onclick="clickme(this)">
                            <img src="image/pro7b1.png" alt="" onclick="clickme(this)">
                            <img src="image/pro7a.png" alt="" onclick="clickme(this)" >
                            <img src="image/pro7b.png" alt="" onclick="clickme(this)" >
                        </div>
                        <div class="preview">
                            <img src="image/pro7main.png" id="imagebox">
                        </div>
                    </div>
                </div>
                <div class="col">
                ...
                <fieldset>
                <div class="content">
                    <h1 style="font-family: 'Bungee Outline', cursive; text-align: center;font-size: 35px;"><mark>IKwong 3 Lite</mark></h1>
                    <h2 style="text-align: center; font-size: 20px;"><small><sup>RM</sup></small>1508.00</h2>
                </div>
                ...
                <select name="Color" id="choice">
                    <option value="choice1">Black</option>
                ...
                <select name="Rateplan" id="choice">
                    ...
                    <option value="choice1">24 Months Postpaid Plan - Omg ABC6</option>
                    </select>
                 </div>
