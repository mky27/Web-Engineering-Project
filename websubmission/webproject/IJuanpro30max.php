...
<head>
    ...
    <link rel="stylesheet" href="IJuanpro30max.css">
        ...
        <div class="hero">
            <div class="row">
                <div class="col">
                    <div class="slider">
                        <div class="product">
                            <img src="image/pro1d.png" alt="" onclick="clickme(this)">
                            <img src="image/pro1c.png" alt="" onclick="clickme(this)" >
                            <img src="image/pro1b.png" alt="" onclick="clickme(this)" >
                            <img src="image/pro1a.png" alt="" onclick="clickme(this)">
                        </div>
                        <div class="preview">
                            <img src="image/pro1d.png" id="imagebox">
                        </div>
                    </div>
                </div>
                <div class="col">
                ...
                <fieldset>
                <div class="content">
                    <h1 style="font-family: 'Bungee Outline', cursive; text-align: center;font-size: 35px;"><mark>IJuan pro 30 Max</mark></h1>
                    <h2 style="text-align: center; font-size: 20px;"><small><sup>RM</sup></small>5000.00</h2>
                </div>
                ...
                <select name="Color" id="choice">
                    <option value="choice1">Dark Blue</option>
                    <option value="choice2">Black</option>
                    <option value="choice3">White</option>
                    <option value="choice4">Gold</option>
                </select>  
                <br><br>
                <label for="choice"><b style="line-height: 20px;">Contract Plan : </b></label>
                    <select name="Rateplan" id="choice">
                        <option value="choice1">-</option>
                        <option value="choice1">24 Months Postpaid Plan - Omg ABC66</option>
                        <option value="choice1">36 Months Postpaid Plan - Omg ABC36</option>
                    </select>
                 </div>
