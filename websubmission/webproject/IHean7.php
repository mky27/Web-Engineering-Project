...
<head>
    ...
    <link rel="stylesheet" href="IHean7.css">
            ...
            <div class="row">
                <div class="col">
                    <div class="slider">
                        ...
                        <div class="preview">
                            <img src="image/pro1a.png" id="imagebox">
                        </div>
                    </div>
                </div>
                <div class="col">
                ...
                <fieldset>
                <div class="content">
                    <h1 style="font-family: 'Bungee Outline', cursive; text-align: center;font-size: 35px;"><mark>IHean 7</mark></h1>
                    <h2 style="text-align: center; font-size: 20px;"><small><sup>RM</sup></small>3288.00</h2>
                </div>
                ...
                <select name="Color" id="choice">
                    <option value="choice1">Gold</option>
                    <option value="choice2">White</option>
                    <option value="choice3">Black</option>
                    <option value="choice4">Dark Blue</option>
                </select>  
                <br><br>
                <label for="choice"><b style="line-height: 20px;">Contract Plan : </b></label>
                    <select name="Rateplan" id="choice">
                        <option value="choice1">-</option>
                        <option value="choice1">24 Months Postpaid Plan - Omg ABC36</option>
                        <option value="choice1">36 Months Postpaid Plan - Omg ABC6</option>
                    </select>
                 </div>
