...
<head>
    ...
    <link rel="stylesheet" href="IYuen13.css">
        ...
        <div class="hero">
            <div class="row">
                <div class="col">
                    <div class="slider">
                        <div class="product">
                            <img src="image/pro2a.png" alt="" onclick="clickme(this)">
                            <img src="image/pro2b.png" alt="" onclick="clickme(this)" >
                            <img src="image/pro2c.png" alt="" onclick="clickme(this)" >
                            <img src="image/pro2d.png" alt="" onclick="clickme(this)">
                            <img src="image/pro2e.png" alt="" onclick="clickme(this)">
                        </div>
                        <div class="preview">
                            <img src="image/pro2a.png" id="imagebox">
                        </div>
                    </div>
                </div>
                <div class="col">
                <p style="color: gray;">Phones / Latest Products</p>
                <fieldset>
                <div class="content">
                    <h1 style="font-family: 'Bungee Outline', cursive; text-align: center;font-size: 35px;"><mark>IYuen 13</mark></h1>
                    <h2 style="font-size: 20px; text-align: center;"><small><sup>RM</sup></small>3608.00</h2>
                </div>
                ...
                <select name="Color" id="choice">
                    <option value="choice1">Purple</option>
                    <option value="choice2">Black</option>
                    <option value="choice3">Red</option>
                    <option value="choice4">Blue</option>
                    <option value="choice5">White</option>
                </select>  
                <br><br>
                <label for="choice"><b style="line-height: 20px;">Contract Plan : </b></label>
                    <select name="Rateplan" id="choice">
                        <option value="choice1">-</option>
                        <option value="choice1">12 Months Postpaid Plan - Omg ABC66</option>
                        <option value="choice1">36 Months Postpaid Plan - Omg ABC66</option>
                    </select>
                 </div>
